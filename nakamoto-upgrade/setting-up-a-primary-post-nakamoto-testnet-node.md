...
Once your signer is upgraded to version 3.1.0.0.4.0 ([here](https://github.com/stacks-network/stacks-core/releases/tag/signer-3.1.0.0.4.0)) you’ll need to run a primary testnet node alongside it.
