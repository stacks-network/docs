...
Product Hunt comes up with one scores for each app — the “community” score.

Their community score is determined only by the number of validated upvotes an app
...
Once each app has a community score, Blockstack converts these scores into
...
First Blockstack's determine a ‘z-score’ for each ranking category. 
This is a statistical technique to account for
...
z-scores results in a final number. A higher number is better than a lower
