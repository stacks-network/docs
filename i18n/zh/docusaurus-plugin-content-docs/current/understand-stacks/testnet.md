...
To get STX tokens from within the Explorer Sandbox, navigate to the "Faucet" tab and click "Request STX" button. If you would like to get enough STX tokens to try out [Stacking](stacking), and click "I want to stack." If you would like to get enough STX tokens to try out [Stacking](stacking), and click "I want to stack."
