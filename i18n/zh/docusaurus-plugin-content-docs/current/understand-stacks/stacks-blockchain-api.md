...
The RESTful JSON API can be used without any authorization. The basepath for the API is: The basepath for the API is: The basepath for the API is:
...
:::caution If you run a local node, it exposes an HTTP server on port `20443`. The info endpoint would be `localhost:20443/v2/info`. ::: The info endpoint would be `localhost:20443/v2/info`. :::
