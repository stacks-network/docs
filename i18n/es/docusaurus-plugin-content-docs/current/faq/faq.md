...
**Escalabilidad de la computación on-chain** Stacks esta diseñado alrededor de un concepto de "cadena virtual", donde los nodos sólo necesitan alcanzar un consenso sobre la “cadena virtual” compartida en la que están interesados. Las cadenas virtuales no interactúan entre sí, y una sola blockchain puede albergar muchas cadenas virtuales. Aunque la cadena virtual específica de Stacks no es Turing completo (i.e. es una lista de instrucciones para construir la base de datos de nombres), es posible crear cadenas virtuales Turing completas como Ethereum. Estas cadenas virtuales pueden vivir en cualquier blockchain para el cual exista un driver, y los clientes de cadenas virtuales sólo necesitan ejecutar sus transacciones en cadena virtual (i.e. Stacks sólo procesan las transacciones en la cadena virtual de Stacks).

Por el contrario, debido a que los contratos inteligentes funcionan en cadena y pueden llamarse unos a otros, todos los nodos Ethereum necesitan procesar todos los cálculos de los contratos inteligentes para llegar a un consenso. Esto puede resultar caro a medida que aumenta el número de contratos inteligentes en funcionamiento, lo que adopta la forma de aumento de la tasa del gas.

**Escalabilidad de la computación Off-chain** Las aplicaciones Stacks son muy similares a las aplicaciones Web hoy en día y casi nunca necesitan interactuar con la blockchain. Para la mayoría de las aplicaciones de Stacks, la blockchain sólo se utiliza para autenticar el código y los datos de la aplicación antes de que el usuario lo ejecute. Por el contrario, las aplicaciones de Ethereum generalmente requieren un contrato inteligente específico de la aplicación, y deben interactuar con la blockchain para llevar a cabo sus operaciones.
