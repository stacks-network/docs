...
Alternatively, there is also a [full mining walkthrough here](https://github.com/stacksfoundation/miner-docs/tree/testnet) with scripts to get a miner up and running.
