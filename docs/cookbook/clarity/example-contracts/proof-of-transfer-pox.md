...
{% code title=".pox-4" lineNumbers="true" fullWidth="false" expandable="true" %}
```clarity
;; The .pox-4 contract
;; Error codes
...
{% hint style="info" %}
Deployed contract page found [here](https://explorer.hiro.so/txid/SP000000000000000000002Q6VF78.pox-4).
{% endhint %}
...
{% embed url="https://youtu.be/2Bmo1cK0C8k?si=qcJgkteesIEmqY6T" %}
...
### Solo Stacking <a href="#solo-stacking" id="solo-stacking"></a>

Solo stacking is the least complex flow, and begins by calling the `stack-stx` function.

#### stack-stx <a href="#stack-stx" id="stack-stx"></a>
...
{% code title="pox-4: stack-stx" expandable="true" %}
```clarity
(define-public (stack-stx (amount-ustx uint)
                          (pox-addr (tuple (version (buff 1)) (hashbytes (buff 32))))
                          (start-burn-ht uint)
...
<summary>Supported reward address types</summary>
...
### Delegated Stacking <a href="#delegated-stacking" id="delegated-stacking"></a>
...
#### delegate-stx <a href="#delegate-stx" id="delegate-stx"></a>
...
{% code title="pox-4: delegate-stx" expandable="true" %}
```clarity
(define-public (delegate-stx (amount-ustx uint)
                             (delegate-to principal)
                             (until-burn-ht (optional uint))
...
#### delegate-stack-stx <a href="#delegate-stack-stx" id="delegate-stack-stx"></a>

Called by the pool operator to partially stack a delegator's STX.

{% code title="pox-4: delegate-stack-stx" expandable="true" %}
```clarity
(define-public (delegate-stack-stx (stacker principal)
                                   (amount-ustx uint)
                                   (pox-addr { version: (buff 1), hashbytes: (buff 32) })
...
## How Stacking Reward Distribution Works <a href="#how-stacking-reward-distribution-works" id="how-stacking-reward-distribution-works"></a>
