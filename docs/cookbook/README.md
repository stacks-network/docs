---
description: Bite-sized code recipes, cooked and ready to serve.
icon: user-chef
metaLinks:
  alternates:
...
<div data-with-frame="true"><figure><img src=".gitbook/assets/stacksdocs-cookbook.png" alt=""><figcaption></figcaption></figure></div>
