...
Thank you for your interest in contributing and helping to make these docs as good as they can be.
...
Don't want to learn it? No need to. Write [a plain text issue on Github](https://github.com/stacks-network/docs/issues/new?assignees=&labels=documentation&template=add-documentation.md&title=%5BAdd+docs%5D)
:::
...
We use [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) as the naming convention for commits. Use it while contributing, please.
