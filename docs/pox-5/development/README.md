...
2. **Open a position** — your user commits assets through one of three paths:
   * [**Paired BTC**](paired-btc.md) — L1 BTC timelock + L2 STX lock. Institutional, protocol bond tranche yield, self-custodial.
   * [**Solo STX**](solo-stx.md) — STX-only stake, no BTC commitment. Earns STX-only staking tranche residual after the protocol bond tranche, ahead of the reserve fund.
