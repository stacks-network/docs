...
<div data-with-frame="true"><figure><img src="../.gitbook/assets/security-budget-cover.png" alt=""><figcaption></figcaption></figure></div>
...
The technical details of how this all works are discussed in the [Block Production](./) section.
