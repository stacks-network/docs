...
Anyone can trigger reward distribution every cycle based on calculated weights. Administrators can update configurations like APR, yield boost multiplier, snapshot length, and number of snapshots per cycle. **v2.0.2 Enhancement:** Reward parameters can now be adjusted more flexibly to respond to market conditions and participation levels.
{% endstep %}
...
* **2026 Update:** Rewards are distributed approximately every two weeks, and participants can track their exact cycle progress through the enhanced dashboard.
...
* **v2.0.2 Enhancement:** APR parameters can now be adjusted more dynamically, with clearer display of reward calculations in the user interface.
...
* Assertions:
  ...
  * Caller must hold at least the minimum required sBTC amount (0.0001 sBTC / 10,000 sats).
* Effect:
  ...
  * **v2.0.2 Enhancement:** Enrollment status is immediately reflected in the web app dashboard.
...
* Effect:
  ...
  * **v2.0.2 Enhancement:** Balance data is immediately visible in the improved dashboard interface.
...
* Effect:
  ...
  * **v2.0.2 Enhancement:** More flexible APR parameters allow for dynamic adjustment of reward caps.
...
* Effect:
  ...
  * **v2.0.2 Enhancement:** Reward amounts are displayed with improved clarity in the dashboard.
...
* update-APR **(v2.0.2 Enhancement: More flexible parameter adjustment)**
...
* current-overview-data **(v2.0.2 Enhancement: Enhanced dashboard metrics)**
...
* reward-amount-for-cycle-and-address **(v2.0.2 Enhancement: Improved visibility in UI)**
...
* is-enrolled-in-next-cycle **(v2.0.2 Enhancement: Status clearly displayed in dashboard)**
* is-enrolled-this-cycle
* get-is-blacklisted
* get-is-blacklisted-list
* get-is-whitelisted-defi
* get-latest-reward-address
* get-participant-cycle-info **(v2.0.2 Enhancement: Enhanced participant data visibility)**
...
* get-contract-sbtc-balance **(v2.0.2 Enhancement: Real-time balance tracking in UI)**
* get-apr-data **(v2.0.2 Enhancement: Flexible APR parameter display)**
...
## Version 2.0.2 Migration Notes

**For existing participants (as of December 15, 2025):**

* If you enrolled in Dual Stacking via the web app before the upgrade, you were automatically migrated to v2.0.2 with no action required.
* If you were receiving Dual Stacking rewards through a participating DeFi application but never enrolled through the web app, you need to enroll at [app.stacks.co](https://app.stacks.co) to continue receiving rewards and access the enhanced dashboard features.
* All existing reward calculations, balances, and cycle participation carry over seamlessly.

**Key improvements in v2.0.2:**

1. **Enhanced Dashboard Visibility**: View your complete sBTC holdings, STX stacking status, current boost multiplier, and projected rewards all in one place.
2. **Flexible Reward Parameters**: Administrators can now adjust APR and other reward parameters more dynamically to respond to market conditions.
3. **Improved Real-time Tracking**: Balance updates and reward calculations are reflected in real-time in the web interface.
4. **Better Enrollment Status**: Clear indication of enrollment status and required actions directly in the dashboard.

***

## 2026 Ecosystem Context

As of January 2026, Dual Stacking represents a mature Bitcoin yield mechanism on Stacks:

* **Current APR**: Approximately 5% APY for fully boosted participants (varies based on pool size and market conditions)
* **Minimum Requirements**:
  * sBTC minting: 0.001 BTC (100,000 sats) via sBTC Bridge
  * Dual Stacking enrollment: 0.0001 sBTC (10,000 sats)
* **Supported Wallets**: Xverse, Leather, with expanding support through WalletConnect integration
* **Integration**: Institutional custody support through partners like Hex Trust, BitGo
* **Roadmap Alignment**: Part of Stacks' broader strategy for sustainable Bitcoin yield, programmable BTC vaults, and enhanced PoX mechanisms

The v2.0.2 upgrade positions Dual Stacking for continued growth as the Bitcoin DeFi ecosystem expands in 2026 and beyond.
