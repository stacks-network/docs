...
export { convertBNSRefToMdx as getStaticProps } from '@common/data/bns-ref'; export { convertBNSRefToMdx as getStaticProps } from '@common/data/bns-ref'; import { BNSErrorcodeReference, BNSFunctionReference } from '@components/bns-ref';
